            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ backgroundColor: '#7B1C1C' }} className="text-white">
                  ...
                  {NS_CATS.map(cat => (
                    <th key={cat} className="text-center px-3 py-3.5 font-bold text-xs uppercase tracking-wider">
                      {cat}
                    </th>
                  ))}
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                <tr className="border-t-2 border-slate-200" style={{ backgroundColor: '#FFF5F5' }}>
                  <td className="px-4 py-3.5 font-black text-xs uppercase tracking-wider" style={{ color: '#7B1C1C' }}>
                    TOTAL
                  </td>
                  ...
                  {NS_CATS.map(cat => (
                    <td key={cat} className="px-3 py-3.5 text-center">
                      <span className="font-black" style={{ color: nsColors[cat] }}>
                        {totals[cat]}
                      </span>
                      <br />
