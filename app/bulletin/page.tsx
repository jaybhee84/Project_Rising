      ...
      <main className="mx-auto max-w-7xl">
        <section className="relative overflow-hidden rounded-3xl border border-amber-300/50 bg-[#0A192F] px-6 py-10 text-white shadow-xl sm:px-10 sm:py-12">
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link href="/activities" className="self-start rounded-full border border-white/20 bg-white/10 px-5 py-2.5 text-xs font-black transition hover:bg-white/20 sm:self-auto">
