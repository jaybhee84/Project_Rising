...
// Define the interface for the Article type
interface Article {
  id: string | number
  title: string
  description?: string
...
const CATEGORY_STYLES: Record<string, { bgColor: string; borderColor: string; icon: string; tag: string }> = {
...
export default function ActivitiesPage() {
  // Pass the type parameter to useState
